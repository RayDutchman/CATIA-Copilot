...
**版本：** 2.2.0 &nbsp;|&nbsp; **发布日期：** 2026-07-01 &nbsp;|&nbsp; **作者：** CHEN Weibo
...
| `catia_copilot/ui/help_dialog.py`（第 76–77、590–591 行） | 帮助窗口 HTML 文本中硬编码了属性名称列表，仅影响界面说明文字，不影响功能 |
| `README.zh-CN.md`（本文件）| 功能一览表中对属性名的文字描述需同步更新 |
