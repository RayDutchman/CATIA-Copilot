...
注意：
  ...
  - ChatScrollArea 用 QSS 覆盖了 qdarkstyle 的 border+padding，viewport 无偏移。
...
class _Layout:
    ...
    TOOL_CARD_PROGRESS_FONT_SIZE: int = 11 # 进度提示文字字体大小（px）
    TOOL_CARD_RESULT_FONT_SIZE: int = 11   # 结果文本框字体大小（px）
